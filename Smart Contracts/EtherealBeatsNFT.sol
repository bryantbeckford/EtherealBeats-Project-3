...
contract EtherealBeatsNFT is ERC721 {
    ...
    function mint(string memory _ipfsHash) public {
        ...
        // Set metadata
        // _setTokenURIs(tokenId, _ipfsHash);
    }

    function _setTokenURI(uint256 tokenId, string memory token_URI) external  {
        require(!_usedURIs[token_URI], "URI already set");    
        _usedURIs[token_URI] = true;
